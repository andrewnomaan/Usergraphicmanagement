...
<body id="home">
    ...
    <section id="<?php echo strtolower($row['category'])?>" class="section-pd">
        <div class="container">
            ...
            <div class="row">
            <?php
            // select graphics which is purchased by particular user
             $sql_graphic="SELECT graphics.*,buy_graphics.user_id from graphics,buy_graphics where graphics.cat_id='$row[id]' and graphics.id=buy_graphics.graphics_id and buy_graphics.user_id='$_SESSION[id]'";
